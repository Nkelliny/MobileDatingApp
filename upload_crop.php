...
function generateNewName($length = 9)
{
	$newname = "";
...
$img_name = getImageName('something','something');
$large_image_name = $img_name . ".jpg";// New name of the large image
$thumb_image_name = $img_name . "_thumb.jpg";// New name of the thumbnail image
...
<head>
	...
	<title>love @ hangoversamuid</title>

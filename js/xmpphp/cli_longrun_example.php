...
$conn = new XMPPHP_XMPP('server.fwends.co.uk', 5222, 'tj-1@server.fwends.co.uk', 'X;9T*WeG8yHH', 'xmpphp', 'server.fwends.co.uk', $printlog=true, $loglevel=XMPPHP_Log::LEVEL_INFO);
$conn->autoSubscribe();

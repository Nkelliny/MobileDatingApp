...
$conn = new XMPPHP_BOSH('server.fwends.co.uk', 5280, 'tj-1@server.fwends.co.uk', 'X;9T*WeG8yHH', 'xmpphp', 'server.fwends.co.uk', $printlog=true, $loglevel=XMPPHP_Log::LEVEL_VERBOSE);
$conn->autoSubscribe();
